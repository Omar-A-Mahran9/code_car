    ...
    <div class="aside-menu flex-column-fluid">
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                <!--@can('view_orders')-->
                <!--    <div class="menu-item">-->
                <!--        <a class="menu-link {{ isTabActive('create') }}" href="{{ route('dashboard.orders.create') }}"-->
                <!--            data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click"-->
                <!--            data-bs-placement="right">-->
                <!--            <span class="menu-icon">-->
                ...
                @can('view_chats')
                    ...
                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion ">
                        <!--begin:Menu link-->
                        <span class="menu-link {{ isTabActive('chats') }}">
                            <span class="menu-icon">
                        ...
                        <div class="menu-sub menu-sub-accordion">
                            ...
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link" href="{{ route('dashboard.chats.index') }}">
                            ...
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link" href="{{ route('dashboard.chats.create') }}">
                                    <span class="menu-bullet">
                                        <i class="fas fa-paper-plane  me-3 "></i> </span>
                                    <span class="menu-title">{{ __('New Message') }}</span>
                                </a>
                                <!--end:Menu link-->
                            </div>
                            <!--end:Menu item-->
                ...
                @can('view_orders')
                    <div class="menu-item">
                        <a class="menu-link {{ isTabActive('orders_not_approval') }}" href="{{ route('dashboard.orders.orders_not_approval') }}"
                            ...
                            <span class="menu-title"> {{ __('Orders Not approval') }}</span>
                        </a>
                    </div>
                @endcan
