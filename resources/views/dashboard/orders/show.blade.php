                ...
                @if ($finalapproval != null)
                    ...
                    <div class="d-flex flex-column flex-xl-row gap-7 gap-lg-10 mb-5">
                        ...
                        <div class="card card-flush  flex-row-fluid">
                            ...
                            <div class="card-header">
                                <div class="card-title">
                                    <h2>{{ __('Order Details') }} ( #{{ $finalapproval['id'] }} )</h2>
                                </div>
                            </div>
                            <!--end::Card header-->
                            <!--begin::Card body-->
                            <div class="card-body pt-0">
                                <div class="table-responsive">
                                    ...
                                    <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                        <!--begin::Table body-->
                                        <tbody class="fw-bold text-gray-600">
                                            @if (isset($finalapproval['orderDetailsCar']) && $finalapproval['orderDetailsCar']['bank_offer_id'])
                                                <tr>
                                                    ...
                                                    <td class="fw-bolder text-end"><a
                                                            href="/dashboard/bank-offers/{{ $finalapproval['orderDetailsCar']->bank_offer->id }}">
                                                            <h5 style="font-weight:bold;color:rgb(0, 74, 111)">
                                                                {{ $finalapproval['orderDetailsCar']->bank_offer->title }}
                                                            </h5>
                                                        </a>
                                                    </td>
                                            ...
                                            @endif
                                            @if (isset($finalapproval['orderDetailsCar']) && $finalapproval['edited_by'])
                                                <tr>
                                                    <td class="text-muted">
                                                        <div class="d-flex align-items-center">
                                                            <span>
                                                                <i class="fas fa-user-tie mx-2"></i>
                                                            </span> {{ __('The fianl approval by ') }}
                                                        </div>
                                                    </td>
                                                    <td class="fw-bolder text-end">
                                                        {{ $finalapproval->employee_edit->name }}
                                                    </td>
                                                </tr>
                                            @endif
                                            @if (isset($finalapproval['orderDetailsCar']) && $finalapproval['orderDetailsCar']['sector_id'])
                                                <tr>
                                                    <td class="text-muted">
                                                        <div class="d-flex align-items-center">
                                                            <span>
                                                    ...
                                                    <td class="fw-bolder text-end">
                                                        {{ $finalapproval['orderDetailsCar']->sector->name }}
                                                    </td>
                                                </tr>
                                            @endif
                                            @if ($finalapproval['city_id'])
                                                <tr>
                                                    <td class="text-muted">
                                                        <div class="d-flex align-items-center">
                                                            <span>
                                                    ...
                                                    <td class="fw-bolder text-end">{{ $finalapproval->city->name }}
                                                    </td>
                                                </tr>
                                            @endif
                                            @if ($finalapproval['nationality_id'])
                                                <tr>
                                                    <td class="text-muted">
                                                        <div class="d-flex align-items-center">
                                                            <span>
                                                    ...
                                                    <td class="fw-bolder text-end">
                                                        {{ $finalapproval->nationality->name }}
                                                    </td>
                                                </tr>
                                            @endif
                                            <!--begin::Date-->
                                            <tr>
                                                ...
                                                <td class="fw-bolder text-end">
                                                    {{ date('Y-m-d', strtotime($finalapproval['created_at'])) }}
                                                </td>
                                            </tr>
                                            <!--end::Date-->
                                            <!--begin::Time-->
                                            <tr>
                                                ...
                                                <td class="fw-bolder text-end">
                                                    {{ date('H:i a', strtotime($finalapproval['created_at'])) }}
                                                </td>
                                            </tr>
                                            <!--end::Time-->
                                        </tbody>
                        ...
                        <div class="card card-flush  flex-row-fluid">
                            ...
                            <div class="card-header d-flex justify-content-between align-items-between">
                                ...
                                @if (isset($finalapproval['orderDetailsCar']) && $finalapproval['orderDetailsCar']['type'] == 'individual')
                                    <div class="ps-4">
                                        <a href="https://wa.me/{{ $finalapproval['phone'] }}?text={{ urlencode(__('السلام عليكم. موقع كود كار للسيارات يرحب بكم ويسعدنا التواصل معك بخصوص طلبك رقم ' . $order['id'] . ' لسيارة: ' . $order['car_name'] . '')) }}"
                                            target="_blank" title="Chat on WhatsApp" class="whatsapp-icon">
                                            <img src="{{ asset('dashboard-assets/media/svg/social-logos/whatsapp.svg') }}"
                                                alt="WhatsApp Logo"
                                                style="width:50px; height: 50px; margin-left: 23px; margin-right: 23px;">
                                ...
                                @else
                                    @if (isset($finalapproval['orderDetailsCar']) && $finalapproval['orderDetailsCar']['cars'])
                                        @foreach (json_decode($finalapproval['orderDetailsCar']['cars'], true) as $car)
                                            @if (isset($car))
                                                {{-- Here you can put any code related to displaying individual cars --}}
                                            @endif <!--end::Cars-->
                                        @endforeach
                                        <div class="ps-4">
                                            <a href="https://wa.me/{{ $finalapproval['phone'] }}?text={{ urlencode(__('السلام عليكم. موقع كود كار للسيارات يرحب بكم ويسعدنا التواصل معك بخصوص طلبك رقم ' . $finalapproval['id'] . ' ' . ' العدد الطلوب' . ' ' . 'سيارة')) }}"
                                                target="_blank" title="Chat on WhatsApp" class="whatsapp-icon">
                                                <img src="{{ asset('dashboard-assets/media/svg/social-logos/whatsapp.svg') }}"
                                                    alt="WhatsApp Logo"
                                                    style="width:50px; height: 50px; margin-left: 23px; margin-right: 23px;">
                                    ...
                                    @else
                                        <a href="https://wa.me/{{ $finalapproval['phone'] ?? 0 }}?text={{ urlencode(__('السلام عليكم. موقع كود كار للسيارات يرحب بكم ويسعدنا التواصل معك بخصوص طلبك رقم ' . $finalapproval['id'] ?? (0 . ' لسيارة: ' . ' ' . $finalapproval['car_name'] ?? (0 . ' ' . 'عدد' . ' ' . $finalapproval['orderDetailsCar']['car_count'] ?? 0)))) }}"
                                            target="_blank" title="Chat on WhatsApp" class="whatsapp-icon">
                                            <img src="{{ asset('dashboard-assets/media/svg/social-logos/whatsapp.svg') }}"
                                                alt="WhatsApp Logo"
                                                style="width:50px; height: 50px; margin-left: 23px; margin-right: 23px;">
                                        ...
                                        <tbody class="fw-bold text-gray-600">
                                            ...
                                            @if ($finalapproval['phone'])
                                                <tr>
                                                    ...
                                                    <td class="fw-bolder text-end">{{ $finalapproval['phone'] }}</td>
                                                </tr>
                                            @endif
                                            @if ($finalapproval['identity_no'])
                                                <tr>
                                                    <td class="text-muted">
                                                        <div class="d-flex align-items-center">
                                                            <span>
                                                    ...
                                                    <td class="fw-bolder text-end">
                                                        {{ __($finalapproval['identity_no']) }}
                                                    </td>
                                                </tr>
                                            @endif
                                            @if ($finalapproval['sex'])
                                                <tr>
                                                    <td class="text-muted">
                                                        <div class="d-flex align-items-center">
                                                            <span>
                                                    ...
                                                    <td class="fw-bolder text-end">{{ __($finalapproval['sex']) }}
                                                    </td>
                                                </tr>
                                            @endif

                                            @if ($finalapproval['email'])
                                                <tr>
                                                    <td class="text-muted">
                                                        <div class="d-flex align-items-center">
                                                            <span>
                                                    ...
                                                    <td class="fw-bolder text-end">{{ $finalapproval['email'] }}
                                                    </td>
                                                </tr>
                                            @endif

                                            @if ($finalapproval['birth_date'])
                                                <tr>
                                                    <td class="text-muted">
                                                        <div class="d-flex align-items-center">
                                                            <span>
                                                    ...
                                                    <td class="fw-bolder text-end">{{ $finalapproval['birth_date'] }}
                                                    </td>
                                                </tr>
                                            @endif
                                            <!--end::Date-->
                        ...
                        @if (isset($finalapproval['orderDetailsCar']) && $finalapproval['orderDetailsCar']['type'] == 'individual')
                            <div class="d-flex flex-column gap-7 gap-lg-10 mt-5">
                                ...
                                <div class="card card-flush  flex-row-fluid overflow-hidden">
                                    ...
                                    <div class="card-header">
                                        <div class="card-title">
                                            <h2>{{ __('Order') }} #{{ $finalapproval['id'] . ' ' }} </h2>
                                        </div>
                                        <div class="card-title">
                                            <h2>{{ __('Order Type') . ' : ' }}
                                                {{ __(ucfirst($finalapproval['orderDetailsCar']['type'])) . ' ' }} </h2>
                                        </div>
                                    </div>
                                    <!--end::Card header-->
                                    <!--begin::Card body-->
                                            ...
                                            <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0">
                                                ...
                                                <tbody class="fw-bold text-gray-600">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex justify-content-end align-items-center">
                                                                @if ($finalapproval->car)
                                                                    <!--begin::Thumbnail-->
                                                                    <a href="/dashboard/cars/{{ $finalapproval['car_id'] }}"
                                                                        class="symbol symbol-50px">
                                                                        <img src="{{ getImagePathFromDirectory($finalapproval->car->main_image, 'Cars') }}"
                                                                            alt="Car Image" class="symbol-label">
                                                                    </a>
                                                                    <div class="ms-5">
                                                                        <a href="/dashboard/cars/{{ $finalapproval['car_id'] }}"
                                                                            target="_blank"
                                                                            class="fw-boldest text-gray-600 text-hover-primary">{{ $finalapproval['car_name'] }}</a>
                                                                    </div>
                                                                @else
                                                                    <div class="ms-5">
                                                                        <a href="#"
                                                    ...
                                                    <tr>
                                                        <td class="fw-boldest">{{ __('Price') }}</td>
                                                        <td class="text-end fw-boldest" colspan="4">
                                                            {{ $finalapproval['price'] . ' ' . currency() }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="fw-boldest">{{ __('Payment Type') }}</td>
                                                        <td class="text-end fw-boldest" colspan="4">
                                                            {{ __(ucfirst($finalapproval['orderDetailsCar']['payment_type'])) }}
                                                        </td>
                                                    </tr>
                                                    @if ($finalapproval['orderDetailsCar']['payment_type'] == 'finance')
                                                        @if ($finalapproval['orderDetailsCar']['work'])
                                                            <tr>
                                                                <td class="fw-boldest">{{ __('Work') }}</td>
                                                                <td class="text-end fw-boldest" colspan="4">
                                                                    {{ $finalapproval['orderDetailsCar']['work'] }}</td>
                                                            </tr>
                                                        @endif
                                                        <tr>
                                                            <td class="fw-boldest">{{ __('Salary') }}</td>
                                                            <td class="text-end fw-boldest" colspan="4">
                                                                {{ $finalapproval['orderDetailsCar']['salary'] . ' ' . currency() }}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="fw-boldest">{{ __('Commitments') }}</td>
                                                            <td class="text-end fw-boldest" colspan="4">
                                                                {{ $finalapproval['orderDetailsCar']['commitments'] . ' ' . currency() }}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="fw-boldest">{{ __('Is there a mortgage loan') }}
                                                            ...
                                                            <td class="text-end fw-boldest" colspan="4">
                                                                {{ $finalapproval['orderDetailsCar']['having_loan'] ? __('Yes') : __('No') }}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="fw-boldest" style="font-weight:900">
                                                        ...
                                                        @if ($finalapproval['orderDetailsCar']['driving_license'])
                                                            <tr>
                                                                <td class="fw-boldest">{{ __('Driving License Status') }}
                                                                </td>
                                                                <td class="text-end fw-boldest" colspan="4">
                                                                    {{ __(str_replace('_', ' ', $finalapproval['orderDetailsCar']['driving_license'])) }}
                                                                </td>
                                                            </tr>
                                                        @endif
                                                        @if ($finalapproval['orderDetailsCar']['traffic_violations'] == 0 || 1)
                                                            <tr>
                                                                <td class="fw-boldest">{{ __('traffic violations') }}
                                                                </td>
                                                                <td class="text-end fw-boldest" colspan="4">
                                                                    {{ $finalapproval['orderDetailsCar']['traffic_violations'] ? __('Yes') : __('No') }}
                                                                </td>
                                                            </tr>
                                                        @endif
                                                        <tr>
                                                            <td class="fw-boldest">{{ __('Installment Time') }}</td>
                                                            <td class="text-end fw-boldest" colspan="4">
                                                                {{ $finalapproval['orderDetailsCar']['installment'] . ' ' . __('years') }}
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td class="fw-boldest">{{ __('The first installment') }}</td>
                                                            <td class="text-end fw-boldest" colspan="4">
                                                                {{ $finalapproval['orderDetailsCar']['first_installment'] }}
                                                                %
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="fw-boldest">
                                                                {{ __('The first installment amount') }}
                                                            </td>
                                                            <td class="text-end fw-boldest" colspan="4">
                                                                {{ $finalapproval['orderDetailsCar']['first_payment_value'] . ' ' . currency() }}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="fw-boldest">{{ __('The last installment') }}</td>
                                                            <td class="text-end fw-boldest" colspan="4">
                                                                {{ $finalapproval['orderDetailsCar']['last_installment'] }}
                                                                %
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="fw-boldest">
                                                                {{ __('The last installment amount') }}
                                                            </td>
                                                            <td class="text-end fw-boldest" colspan="4">
                                                                {{ $finalapproval['orderDetailsCar']['last_payment_value'] . ' ' . currency() }}
                                                            </td>
                                                        </tr>
                                                        @if ($finalapproval['orderDetailsCar']['Monthly_installment'])
                                                            <tr>
                                                                <td class="fw-boldest">{{ __('The installment amount') }}
                                                                </td>
                                                                <td class="text-end fw-boldest" colspan="4">
                                                                    {{ $finalapproval['orderDetailsCar']['Monthly_installment'] . ' ' . currency() }}
                                                                </td>
                                                            </tr>
                                                        @endif

                                                        @if ($finalapproval['orderDetailsCar']['bank'])
                                                            <tr>
                                                                <td class="fw-boldest">{{ __('Bank') }}</td>
                                                                <td class="text-end fw-boldest" colspan="4">
                                                                    {{ $finalapproval['orderDetailsCar']['bank']['name'] }}
                                                                </td>
                                                            </tr>
                                                        @endif
                                                    @endif
                            ...
                            <div class="d-flex flex-column gap-7 gap-lg-10 mt-5">
                                ...
                                <div class="card card-flush  flex-row-fluid overflow-hidden">
                                    ...
                                    <div class="card-header">
                                        ...
                                        <div class="card-title">
                                            <h2>{{ __('Order Type') . ' : ' }}
                                                {{ __(ucfirst($finalapproval['orderDetailsCar']['type'] ?? 0)) . ' ' }}
                                            </h2>
                                        </div>
                                    </div>
                                    <!--end::Card header-->
                                                ...
                                                <tbody class="fw-bold text-gray-600">
                                                    ...
                                                    @if (isset($finalapproval['orderDetailsCar']) && !$finalapproval['orderDetailsCar']['cars'])
                                                        <tr>
                                                            <td class="fw-boldest">{{ __('Price') }}</td>
                                                            <td class="text-end fw-boldest" colspan="4">
                                                                {{ $finalapproval->car->getPriceAfterVatAttribute() . ' ' . currency() }}
                                                            </td>
                                                        </tr>
                                                        @if ($finalapproval['orderDetailsCar']['car_count'])
                                                            <tr>
                                                                <td class="fw-boldest">{{ __('Total Price') }}</td>
                                                                <td class="text-end fw-boldest" colspan="4">
                                                                    {{ $finalapproval['price'] * $finalapproval['orderDetailsCar']['car_count'] . ' ' . currency() }}
                                                                </td>
                                                            </tr>
                                                        @endif
                                                    @endif
                                                    <tr>
                                                        <td class="fw-boldest">{{ __('Payment Type') }}</td>
                                                        <td class="text-end fw-boldest" colspan="4">
                                                            {{ __(ucfirst($finalapproval['orderDetailsCar']['payment_type'] ?? 0)) }}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="fw-boldest">{{ __('Organization Name') }}</td>
                                                        <td class="text-end fw-boldest" colspan="4">
                                                            {{ $finalapproval['orderDetailsCar']['organization_name'] ?? 0 }}
                                                        </td>
                                                    </tr>
                                                    @if (isset($finalapproval['orderDetailsCar']) && $finalapproval['orderDetailsCar']['organization_email'])
                                                        <tr>
                                                            <td class="fw-boldest">{{ __('Organization Email') }}</td>
                                                            <td class="text-end fw-boldest" colspan="4">
                                                                {{ $finalapproval['orderDetailsCar']['organization_email'] ?? 0 }}
                                                            </td>
                                                        </tr>
                                                    @endif
                                                    @if (isset($finalapproval['orderDetailsCar']) && $finalapproval['orderDetailsCar']['commercial_registration_no'])
                                                        <tr>
                                                            <td class="fw-boldest">{{ __('commercial registration no') }}
                                                            </td>
                                                            <td class="text-end fw-boldest" colspan="4">
                                                                {{ $finalapproval['orderDetailsCar']['commercial_registration_no'] ?? 0 }}
                                                            </td>
                                                        </tr>
                                                    @endif
                                                    @if ($organization_activity)
                                                    ...
                                                    <tr>
                                                        <td class="fw-boldest">{{ __('Organization Age') }}</td>
                                                        <td class="text-end fw-boldest" colspan="4">
                                                            {{ $finalapproval['orderDetailsCar']['organization_age'] ?? 0 . ' ' . __('Years') }}
                                                        </td>
                                                    </tr>
                                                    @if (isset($finalapproval['orderDetailsCar']) && $finalapproval['orderDetailsCar']['car_count'])
                                                        <tr>
                                                            <td class="fw-boldest">{{ __('Cars Count') }}</td>
                                                            <td class="text-end fw-boldest" colspan="4">
                                                                {{ $finalapproval['orderDetailsCar']['car_count'] ?? 0 . ' ' . __('Cars') }}
                                                            </td>
                                                        </tr>
                                                    @endif
                                                    @if (isset($finalapproval['orderDetailsCar']) && $finalapproval['orderDetailsCar']['bank'])
                                                        <tr>
                                                            <td class="fw-boldest">{{ __('Bank') }}</td>
                                                            <td class="text-end fw-boldest" colspan="4">
                                                                {{ $finalapproval['orderDetailsCar']['bank']['name'] ?? 0 }}
                                                            </td>
                                                        </tr>
                                                    @endif
                                                    @if (isset($finalapproval['orderDetailsCar']) && $finalapproval['orderDetailsCar']['payment_type'] == 'finance')
                                                        @if (isset($finalapproval['orderDetailsCar']) && $finalapproval['orderDetailsCar']['organization_location'])
                                                            <tr>
                                                                <td class="fw-boldest">
                                                                    {{ __("The company's headquarter") }}
                                                                </td>
                                                                <td class="text-end fw-boldest" colspan="4">
                                                                    {{ $finalapproval['orderDetailsCar']['organization_location'] ?? 0 }}
                                                                </td>
                                                            </tr>
                                                        @endif
                                                    @endif
                        ...
                        <div class="d-flex flex-column gap-7 gap-lg-10">
                            ...
                            <div class="card card-flush flex-row-fluid overflow-hidden">
                                ...
                                <div class="card-header">
                                    ...
                                    <div class="card-title">
                                        <h2>{{ __('Order Type') . ' : ' }}
                                            {{ __(str_replace('_', ' ', $finalapproval['type'])) . ' ' }} </h2>
                                    </div>
                                </div>
                                <!--end::Card header-->
                                <!--begin::Card body-->
                    ...
                    <!-- Assuming you are using Bootstrap that comes with Metronic -->
                    @if (
                        $finalapproval['identity_Card'] ||
                            $finalapproval['License_Card'] ||
                            $finalapproval['Hr_Letter_Image'] ||
                            $finalapproval['Insurance_Image']
                    )
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                                        @if ($finalapproval['identity_Card'])
                                            <a href="{{ route('dashboard.files.download', $finalapproval['identity_Card']) }}"
                                                class="btn btn-success me-md-2" target="_blank">
                                                <i class="bi bi-file-earmark-arrow-down"></i>
                                                {{ __('Download Identity Card') }}
                                            </a>
                                        @endif
                                        @if ($finalapproval['License_Card'])
                                            <a href="{{ route('dashboard.files.download', $finalapproval['License_Card']) }}"
                                                class="btn btn-info me-md-2" target="_blank">
                                                <i
                                                    class="bi bi-file-earmark-arrow-down"></i>{{ __('Download Identity License Card') }}
                                            </a>
                                        @endif
                                        @if ($finalapproval['Hr_Letter_Image'])
                                            <a href="{{ route('dashboard.files.download', $finalapproval['Hr_Letter_Image']) }}"
                                                class="btn btn-warning me-md-2" target="_blank">
                                                <i
                                                    class="bi bi-file-earmark-arrow-down"></i>{{ __('Download License Hr Letter Image') }}
                                            </a>
                                        @endif
                                        @if ($finalapproval['Insurance_Image'])
                                            <a href="{{ route('dashboard.files.download', $finalapproval['Insurance_Image']) }}"
                                                class="btn btn-primary me-md-2" target="_blank">
                                                <i class="bi bi-file-earmark-arrow-down"></i>
                                                {{ __('Download Insurance Image') }}
                                            </a>
                                                                ...
                                                                <div class="col-md-4 fv-row mb-5">
                                                                    ...
                                                                    <div class="form-floating">
                                                                        <input type="text" class="form-control"
                                                                            ...
                                                                            placeholder="example" />
                                                                        <label
                                                                            for="salary_inp">{{ __('Salary') }}</label>
                                                                    </div>
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="col-md-3 fv-row">
                                                                    ...
                                                                    <div class="d-flex gap-3  justify-content-center">
                                                                        ...
                                                                        <label>
                                                                            <input class="form-check-input"
                                                                                type="radio" name="department_loan"
                                                                                value="false"
                                                                ...
                                                                <div class="col-md-3 fv-row">
                                                                    ...
                                                                    <div class="d-flex gap-3  justify-content-center">
                                                                        <label>
                                                                            <input class="form-check-input"
                                                                                type="radio" name="driving_license"
                                                                                value="true"
                                                            ...
                                                            <div class="col-md-3 fv-row">
                                                                ...
                                                                <div class="col-md-3 fv-row">
                                                                    ...
                                                                    <div class="d-flex gap-3  justify-content-center">
                                                                        <label>
                                                                            <input class="form-check-input"
                                                                                type="radio" name="traffic_violations"
                                                                                value="true"
                                                    ...
                                                    <div class="d-flex justify-content-between border-top py-10 px-10">
                                                        ...
                                                        <div>
                                                            ...
                                                            <button type="submit"
                                                                ...
                                                                <!-- begin :: Indicator -->
                                                                <span
                                                                    class="indicator-progress">{{ __('Please wait ...') }}
                                                                    <span
                                ...
                                <div class="card-body pt-0">
                                    <div class="row justify-content-center">
                                        <div class="col-xl-12">
                                            ...
                                            <form action="{{ route('dashboard.orders.final_approval') }}"
                                                class="form" method="post" id="submitted-form"
                                                data-redirection-url="{{ route('dashboard.orders.index') }}">
                                                        ...
                                                        <div class="row mb-10">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-4 fv-row mb-5">
                                                                    ...
                                                                    <div class="form-floating">
                                                                        <select class="form-select"
                                                                            data-control="select2" id="bank_inp_ind"
                                                                            name="bank"
                                                                            data-placeholder="{{ __('Bank') }}"
                                                                            data-dir="{{ isArabic() ? 'rtl' : 'ltr' }}">
                                                                            <option value=""
                                                                ...
                                                                <div class="col-md-4 fv-row mb-5">
                                                                    ...
                                                                    <div class="form-floating">
                                                                        <select class="form-select"
                                                                            data-control="select2" id="nationality_inp"
                                                                            name="nationality_id"
                                                                            data-placeholder="{{ __('The nationality') }}"
                                                                            data-dir="{{ isArabic() ? 'rtl' : 'ltr' }}">
                                                                            <option value=""
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4 fv-row">
                                                                ...
                                                                <div class="form-floating">
                                                                    <input type="text" class="form-control"
                                                                        id="organization_name_inp"
                                                                        name="organization_name" placeholder="example"
                                                            ...
                                                            <div class="col-md-4 fv-row mb-3">
                                                                ...
                                                                <p class="invalid-feedback"
                                                                    id="commercial_registration_no"></p>
                                                            </div>
                                                            ...
                                                            <div class="col-md-4 fv-row mb-3">
                                                                ...
                                                                <div class="form-floating">
                                                                    ...
                                                                    <label
                                                                        for="car_count_inp">{{ __('car count') }}</label>
                                                                </div>
