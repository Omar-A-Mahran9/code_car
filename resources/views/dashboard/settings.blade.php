                ...
                <div class="fv-row row mb-15 mt-5">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control" name="males_insurance"
                            value="{{ settings()->getSettings('males_insurance') ?? 3.75 }}" id="males_insurance_inp"
                            placeholder="{{ __('Enter the males insurance in percentage') }}" step="0.001">
                ...
                <div class="fv-row row mb-15">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="" id="meta_tag_keyword_en_inp" name="meta_tag_keyword_en"
                            value="{{ settings()->getSettings('meta_tag_keyword_en') ?? '' }}"
