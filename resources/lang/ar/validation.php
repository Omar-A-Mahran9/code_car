...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'category_id' => 'الصنف',
        'category' => 'الصنف',
        'firstـbatch'=>"الدفعة الأولى",
        'lastـbatch'=>"الدفعة الأخيرة",
        ...
        'installment' => "سنوات القسط",
        'first_batch' => 'الدفعة الاولى',
        'last_batch' => 'الدفعة الاخيرة',
        'client_name' => 'اسم العميل',
        'monthlyـcometment' => 'الالتزمات الشهرية',
        'monthly cometment' => 'الالتزمات الشهرية',
                'Monthly_cometment' => 'الالتزمات الشهرية',

        'organization type' => 'نوع الموؤسسة',
        'organizationـtype' => 'نوع الموؤسسة',
